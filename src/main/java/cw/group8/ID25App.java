...
public class ID25App {
    ...
    public ArrayList<city> getAllCitiesContinent(Connection con)
    {
        try
        {
            ...
            String strSelect =
                    "SELECT  city.name, city.population FROM city INNER JOIN country on country.Capital=city.ID where country.Continent='North America' ORDER BY city.population DESC";
