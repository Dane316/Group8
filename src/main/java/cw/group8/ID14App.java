...
public class ID14App
{
   /** ID 14
     ...
     */
    public ArrayList<city> getAllCitiesWorld(Connection con)
    {
        try
        {
    ...
    {
        // Print header
        System.out.printf("All the cities in the world organised by largest population to smallest.\n");
