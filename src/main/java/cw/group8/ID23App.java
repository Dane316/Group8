...
public class ID23App
{
     ...
     */
    public ArrayList<city> getTopCitiesDistrict(Connection con)
    {
        try
        {
    ...
    {
        // Print header
        out.printf("The top 10 populated cities in the district of Texas by largest population to smallest.\n");
