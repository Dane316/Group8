...
public class ID09App
{
     ...
     */
    public ArrayList<country> getAllCountriesContinent(Connection con)
    {
        try
        {
    ...
    {
        // Print header
        out.printf("All the countries in North America organised by largest population to smallest.\n");
