...
public class ID13App
{
     ...
     */
    public ArrayList<country> getTopCountriesRegion(Connection con)
    {
        try
        {
    ...
    {
        // Print header
        System.out.printf("The top 10 populated countries in the Caribbean region.\n");
