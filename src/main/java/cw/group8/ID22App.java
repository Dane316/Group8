...
public class ID22App
{
     ...
     */
    public ArrayList<city> getTopCitiesCountry(Connection con)
    {
        try
        {
    ...
    {
        // Print header
        out.printf("The top 10 populated cities in the country of North America by largest population to smallest.\n");
