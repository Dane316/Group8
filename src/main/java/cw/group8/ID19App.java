...
public class ID19App
{
     ...
     */
    public ArrayList<city> getTopCitiesWorld(Connection con)
    {
        try
        {
    ...
    {
        // Print header
        System.out.printf("The top 10 populated cities in the world by largest population to smallest.\n");
