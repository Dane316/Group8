...
public class ID20App
{
   /** ID 20
     ...
     */
    public ArrayList<city> getTopCitiesContinent(Connection con)
    {
        try
        {
    ...
    {
        // Print header
        System.out.printf("The top 10 populated cities in the continent of North America by largest population to smallest.\n");
