...
public class ID17App
{
     ...
     */
    public ArrayList<city> getAllCitiesCountry(Connection con)
    {
        try
        {
    ...
    {
        // Print header
        System.out.printf("All the cities in the country of Afghanistan by largest population to smallest.\n");
